...
namespace TraceUtils
{
	...
	bool OverlapCapsuleAnyByProfile(const UWorld* World, const FVector& Position, float CapsuleRadius, float CapsuleHalfHeight, FQuat Rotation, FName ProfileName, FCollisionQueryParams& QueryParams, bool bDrawDebug = false, float DrawTime = -1.0f, FColor TraceColor = FColor::Red);

	bool OverlapCapsuleBlockingByProfile(const UWorld* World, const FVector& Position, float CapsuleRadius, float CapsuleHalfHeight, FQuat Rotation, FName ProfileName, FCollisionQueryParams& QueryParams, bool bDrawDebug = false, float DrawTime = -1.0f, FColor TraceColor = FColor::Red);
